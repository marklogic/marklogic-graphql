...
const simpleGraphQlJoinQueryString = "query humansCarsJoin { Humans (id: \"1000\") { id name height Cars(id: \"2\") { ownerId ownerId @childJoinColumn id @parentJoinColumn model year } } }";
...
const rawExpectedResult = {"data":{"Humans":[{"id":1000, "name":"Jane", "height":65, "Cars":[{"ownerId":1000, "model":"Camry", "year":"2015"}]}]}};
