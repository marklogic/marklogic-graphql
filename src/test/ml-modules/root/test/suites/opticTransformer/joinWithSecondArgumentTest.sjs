...
const simpleGraphQlJoinQueryString = `query humansCarsJoin { Humans { id name height Cars(id: "2") { ownerId model year } id } }`;
...
const rawExpectedResult = {"data":{"Humans":[{"id":1, "name":"John", "height":70, "Cars":[]}, {"id":2, "name":"Jim", "height":75, "Cars":[]}, {"id":3, "name":"Joe", "height":80, "Cars":[]}, {"id":1000, "name":"Jane", "height":65, "Cars":[{"ownerId":1000, "model":"Camry", "year":"2015"}]}, {"id":1001, "name":"Jenny", "height":65, "Cars":[]}, {"id":1002, "name":"Joan", "height":65, "Cars":[]}]}};
