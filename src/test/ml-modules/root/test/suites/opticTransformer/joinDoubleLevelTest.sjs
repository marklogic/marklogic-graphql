...
const simpleGraphQlJoinQueryString = `query nestedJoin { Humans { id name height Houses { ownerId number street Rooms { houseId type } id } id } }`;
...
const rawExpectedResult = {"data":{"Humans":[{"id":1, "name":"John", "height":70, "Houses":[]}, {"id":2, "name":"Jim", "height":75, "Houses":[{"ownerId":2, "number":"415", "street":"Elm", "Rooms":[{"houseId":1, "type":"Kitchen"}]}]}, {"id":3, "name":"Joe", "height":80, "Houses":[{"ownerId":3, "number":"656", "street":"Main", "Rooms":[{"houseId":2, "type":"Bedroom"}, {"houseId":2, "type":"Dining"}]}, {"ownerId":3, "number":"653", "street":"Second", "Rooms":[{"houseId":3, "type":"Living"}]}]}, {"id":1000, "name":"Jane", "height":65, "Houses":[]}, {"id":1001, "name":"Jenny", "height":65, "Houses":[]}, {"id":1002, "name":"Joan", "height":65, "Houses":[]}]}};
